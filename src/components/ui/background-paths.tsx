...
function FloatingPaths({ position }: { position: number }) {
  ...
  return (
    <div className="pointer-events-none absolute inset-0">
      <svg className="h-full w-full text-[#7C3AED]" viewBox="0 0 696 316" fill="none">
...
export function BackgroundPaths({
  ...
  return (
    <div className="relative flex min-h-screen w-full items-center justify-center overflow-hidden bg-[#F8F8FC]">
